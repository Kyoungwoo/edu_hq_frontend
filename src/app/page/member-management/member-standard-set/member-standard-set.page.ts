...
export class MemberStandardSetPage implements OnInit {
  ...
  getForm() {
    ...
    //console.log("getForm() belong_data = " + JSON.stringify(belong_data));

    this.contractType = belong_data.company_contract_type;
    console.log("getForm() contractType = " + this.contractType);
  ...
  async addSafeJob() {
    this.safeJobForm.company_id = 1; //this.user.userData.belong_data.company_id;
