...
exports.SupervisionApprovalEditPage = exports.ApprovalItem = exports.BasicItem = void 0;
...
var SupervisionApprovalEditPage = /** @class */ (function () {
    function SupervisionApprovalEditPage(_modal_, connect, user, toast, alert, loading) {
    ...
    SupervisionApprovalEditPage.prototype.ngOnInit = function () {
    ...
    //이메일
    SupervisionApprovalEditPage.prototype.overlapEmail = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.connect.run('/usermanage/approval/super/overlap/email', { user_email: user_email, user_id: user_id })];
                    case 1:
                        res = _b.sent();
    ...
    //휴대폰
    SupervisionApprovalEditPage.prototype.overlapPhone = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, user_phone, user_id, res;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.formBasic, user_phone = _a.user_phone, user_id = _a.user_id;
                        if (!user_phone)
                            return [2 /*return*/, this.validator.user_phone = null];
                        if (!user_id)
                            return [2 /*return*/, this.validator.user_id = null];
                        return [4 /*yield*/, this.connect.run('/usermanage/approval/super/overlap/phone', { user_phone: user_phone, user_id: user_id })];
                    case 1:
                        res = _b.sent();
    ...
    SupervisionApprovalEditPage.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            var loading;
    ...
    //기본정보
    SupervisionApprovalEditPage.prototype.getItem = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connect.run('/usermanage/approval/super/basic/detail', this.form, {
    ...
    //소속정보
    SupervisionApprovalEditPage.prototype.getBelong = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connect.run('/usermanage/approval/super/belong/detail', this.form, {})];
                    case 1:
                        res = _a.sent();
                        if (res.rsCode === 0) {
    ...
    //비밀번호
    SupervisionApprovalEditPage.prototype.getPassword = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 저장(수정)
    SupervisionApprovalEditPage.prototype.submit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.form.session_company_id = this.user.userData.belong_data.company_id;
    ...
    //가입승인
    SupervisionApprovalEditPage.prototype.approval = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal, data;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    //기본정보 수정
    SupervisionApprovalEditPage.prototype.BasicSubmit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connect.run('/usermanage/approval/super/basic/update', __assign(__assign({}, this.form), this.formBasic), {})];
                    case 1:
                        res = _a.sent();
                        if (res.rsCode === 0) {
                        }
    ...
    //소속정보 수정
    SupervisionApprovalEditPage.prototype.BelongSubmit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connect.run('/usermanage/approval/super/belong/update', __assign(__assign({}, this.form), this.formApproval), {})];
                    case 1:
                        res = _a.sent();
                        if (res.rsCode === 0) {
    ...
    __decorate([
        core_1.Input()
    ], SupervisionApprovalEditPage.prototype, "item");
    SupervisionApprovalEditPage = __decorate([
        core_1.Component({
    ...
    return SupervisionApprovalEditPage;
}());
exports.SupervisionApprovalEditPage = SupervisionApprovalEditPage;
