...
exports.PartnerApprovalListPage = void 0;
...
var partner_approval_edit_page_1 = require("../partner-approval-edit/partner-approval-edit.page");
var security_password_component_1 = require("../security-password/security-password.component");
var PartnerApprovalInfo = /** @class */ (function () {
    function PartnerApprovalInfo() {
    }
    return PartnerApprovalInfo;
}());
var PartnerApprovalListPage = /** @class */ (function () {
    function PartnerApprovalListPage(user, modal, connect, date, toast, nav, file) {
        this.user = user;
        this.modal = modal;
        ...
        this.validator = new connect_service_1.Validator(new PartnerApprovalInfo()).validator;
        this.selectedList = [];
        this.permission = {
            companyChange: false,
    ...
    PartnerApprovalListPage.prototype.ngOnInit = function () {
    ...
    PartnerApprovalListPage.prototype.getPermission = function () {
    ...
    PartnerApprovalListPage.prototype.get = function (limit_no) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.connect.run('/usermanage/approval/company/list', this.form)];
                    case 1:
                        res = _a.sent();
                        if (res.rsCode === 0) {
                            this.res = res;
    ...
    PartnerApprovalListPage.prototype.getPassword = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PartnerApprovalListPage.prototype.edit = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modal.create({
                            component: partner_approval_edit_page_1.PartnerApprovalEditPage,
                            componentProps: {
                                item: item,
                                state: 'partner'
                            }
    ...
    PartnerApprovalListPage.prototype.approval = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PartnerApprovalListPage = __decorate([
        core_1.Component({
    ...
    return PartnerApprovalListPage;
}());
exports.PartnerApprovalListPage = PartnerApprovalListPage;
