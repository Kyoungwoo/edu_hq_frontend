...
@Component({
  ...
  templateUrl: './incongruity-detail-search.page.html',
  styleUrls: ['./incongruity-detail-search.page.scss'],
})
export class IncongruityDetailSearchPage implements OnInit {
