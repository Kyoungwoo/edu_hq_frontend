...
exports.ConfirmProgressListPage = void 0;
var core_1 = require("@angular/core");
var confirm_progress_detail_search_page_1 = require("../confirm-progress-detail-search/confirm-progress-detail-search.page");
var ConfirmProgressItem = /** @class */ (function () {
    function ConfirmProgressItem() {
    }
    return ConfirmProgressItem;
}());
var ConfirmProgressListPage = /** @class */ (function () {
    function ConfirmProgressListPage(_modal, user, connect, toast, date, approval) {
        this._modal = _modal;
        this.user = user;
     ...
     */
    ConfirmProgressListPage.prototype.get = function (limit_no) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.connect.run('/approval/board/fin/get', this.form, { loading: true })];
                    case 1:
                        _a.res = _b.sent();
     ...
     * 모바일 무한스크롤 시, 사용된다.
     */
    ConfirmProgressListPage.prototype.getMobile = function ($event) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    ConfirmProgressListPage.prototype.detail = function (item) {
        this.approval.getComponent(item.ctgo_approval_module_id, item.target_id);
    };
    ConfirmProgressListPage.prototype.openDetailSearch = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._modal.create({
                            component: confirm_progress_detail_search_page_1.ConfirmProgressDetailSearchPage,
                            componentProps: {
                                form: this.form
                            }
                        })];
    ...
    ConfirmProgressListPage = __decorate([
        core_1.Component({
    ...
    return ConfirmProgressListPage;
}());
exports.ConfirmProgressListPage = ConfirmProgressListPage;
