...
exports.SupervisionListPage = void 0;
var core_1 = require("@angular/core");
var supervision_edit_page_1 = require("../supervision-edit/supervision-edit.page");
var SupervisionListPage = /** @class */ (function () {
    function SupervisionListPage(modal, connect, user, toast) {
        this.modal = modal;
    ...
    SupervisionListPage.prototype.ngOnInit = function () {
        this.ctgoBusiness = {
            errorStatus: null,
            rsCode: null,
            rsObj: null,
    ...
    SupervisionListPage.prototype.getList = function (limit_no) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.connect.run('/project/company/masters/list', this.form, { loading: true })];
                    case 1:
                        res = _a.sent();
                        if (res.rsCode === 0) {
                            this.res = res;
    ...
    SupervisionListPage.prototype.edit = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var modal, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modal.create({
                            component: supervision_edit_page_1.SupervisionEditPage,
                            componentProps: {
    ...
    SupervisionListPage.prototype.getCtgoRegional = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
    ...
    SupervisionListPage.prototype.getCtgoBusiness = function (ev) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    SupervisionListPage = __decorate([
        core_1.Component({
    ...
    return SupervisionListPage;
}());
exports.SupervisionListPage = SupervisionListPage;
