...
exports.WorkerMinutesSelectTypePage = void 0;
var core_1 = require("@angular/core");
var worker_minutes_edit_page_1 = require("../worker-minutes-edit/worker-minutes-edit.page");
var WorkerMinutesSelectTypePage = /** @class */ (function () {
    function WorkerMinutesSelectTypePage(_modal, toast) {
        this._modal = _modal;
        this.toast = toast;
        this.form = {
    ...
    WorkerMinutesSelectTypePage.prototype.ngOnInit = function () {
    };
    WorkerMinutesSelectTypePage.prototype.submit = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._modal.dismiss()];
                    case 1:
                        _a.sent();
    ...
    __decorate([
        core_1.Input()
    ], WorkerMinutesSelectTypePage.prototype, "project_id");
    WorkerMinutesSelectTypePage = __decorate([
        core_1.Component({
    ...
    return WorkerMinutesSelectTypePage;
}());
exports.WorkerMinutesSelectTypePage = WorkerMinutesSelectTypePage;
