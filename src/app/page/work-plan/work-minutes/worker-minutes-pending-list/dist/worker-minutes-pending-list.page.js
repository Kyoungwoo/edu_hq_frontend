...
exports.WorkerMinutesPendingListPage = void 0;
var core_1 = require("@angular/core");
var worker_minutes_edit_page_1 = require("../worker-minutes-edit/worker-minutes-edit.page");
var WorkerMinutesPendingListPage = /** @class */ (function () {
    function WorkerMinutesPendingListPage(connect, toast, _modal) {
    ...
    WorkerMinutesPendingListPage.prototype.ngOnInit = function () {
        this.get();
    };
    WorkerMinutesPendingListPage.prototype.get = function (limit_no) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.connect.run('/board/approval/req/get', this.form, { loading: true })];
                    case 1:
                        _a.res = _b.sent();
     ...
     * 모바일 무한스크롤 시, 사용된다.
     */
    WorkerMinutesPendingListPage.prototype.getMobile = function ($event) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.connect.run('/board/approval/req/get', this.form, {})];
                    case 1:
                        res = _a.sent();
                        if (res.rsCode === 0) {
                            /**
    ...
    WorkerMinutesPendingListPage.prototype.edit = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var modal, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    WorkerMinutesPendingListPage = __decorate([
        core_1.Component({
    ...
    ], WorkerMinutesPendingListPage);
    return WorkerMinutesPendingListPage;
}());
exports.WorkerMinutesPendingListPage = WorkerMinutesPendingListPage;
