...
var approval_zoom_component_1 = require("../approval-zoom/approval-zoom.component");
var ApprovalDocumentComponent = /** @class */ (function () {
    function ApprovalDocumentComponent(_modal) {
        this._modal = _modal;
    ...
    ApprovalDocumentComponent.prototype.mobilePopup = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cloneEl, modal;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(window.innerWidth <= 768)) return [3 /*break*/, 2];
                        cloneEl = this.documentLayout.nativeElement.cloneNode(true);
                        return [4 /*yield*/, this._modal.create({
                                component: approval_zoom_component_1.ApprovalZoomComponent,
                                componentProps: {
                                    zoomEl: cloneEl
                                }
                            })];
    ...
    __decorate([
        core_1.ViewChild('documentLayout')
    ], ApprovalDocumentComponent.prototype, "documentLayout");
