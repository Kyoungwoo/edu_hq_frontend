...
export class SideMenuAdminComponent implements OnInit {
  ...
  menuList:MenuItem[] = [
    { title: '통합관제', img: 'assets/img/control-center.svg', subMenuList: [
      { title: '통합관제', link: ''}
    ]},
    { title: '결재', img: 'assets/img/sign.svg', subMenuList: [
      { title: '미결함', link: ''},
    ...
    { title: '안전교육', img: 'assets/img/safety-education.svg', subMenuList: [
      { title: '교육현황', link: ''},
      { title: '교육 결과 보고', link: ''},
      { title: '교육이력', link: ''}
    ]},
    { title: '작업계획', img: 'assets/img/work-plan.svg', subMenuList: [
    ...
    { title: '작업관리', img: 'assets/img/work-management.svg', subMenuList: [
      { title: '출역 현황', link: ''},
      { title: 'TBM 일지', link: ''},
      { title: '점검현황', link: ''},
    ...
    { title: '장비관리', img: 'assets/img/equipment-management.svg', subMenuList: [
      { title: '중장비 관리', link: ''},
      { title: '스마트 안전 장비\n등록/관리', thirdMenuList: [
        { title: '시리얼 No', link: '' },
        { title: '개인 디바이스', link: '' },
    ...
    { title: '위험작업관리', img: 'assets/img/dangerous-management.svg', subMenuList: [
      { title: '중장비 접근', link: ''},
      { title: '안전고리 체결', link: ''},
      { title: '밀폐 환경 정보', link: ''}
    ]},
