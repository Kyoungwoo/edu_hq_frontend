...
export class SideMenuUserComponent implements OnInit {
  ...
  menuList:MenuItem[] = [
    ...
    { src:'assets/img/menu/work-plan.svg', title: '작업계획', subMenuList: [
      { title: '위험성평가', link: '', params: {}, permission: () => { return true }},
    ...
    { src:'assets/img/menu/safety-education.svg', title: '안전교육', subMenuList: [
      { title: '교육현황', link: '', params: {}, permission: () => { return true }},
      { title: '나의 교육', link: '', params: {}, permission: () => { return true }},
      { title: '교육 결과보고', link: '', params: {}, permission: () => { return true }}
    ]},
    { src:'assets/img/menu/today-work.svg', title: '오늘의 작업', subMenuList: [
      { title: '나의 출입 현황', link: '', params: {}, permission: () => { return true }},
    ...
    { src:'assets/img/menu/emergency-management.svg', title: '비상상황\n관리', subMenuList: [
    ...
    { src:'assets/img/menu/control-center.svg',title: '통합관제', subMenuList: [
      { title: '지역본부 모니터링', link: '/each-device-list', params: {}, permission: () => { return true }},
      { title: '현장 모니터링', link: '/heavy-device-list', params: {}, permission: () => { return true }}
    ]},
    ...
    { src:'assets/img/menu/sign.svg',title: '결재', subMenuList: [
      { title: '미결함', link: '/each-device-list', params: {}, permission: () => { return true }},
      { title: '문서함', link: '/heavy-device-list', params: {}, permission: () => { return true }},
      { title: '위임관리', link: '/danger-area-list', params: {}, permission: () => { return true }}
    ]},
