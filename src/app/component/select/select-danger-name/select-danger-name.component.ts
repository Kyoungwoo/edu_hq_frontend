...
import { ProjectItem, ProjectSearchType, SearchDangerNameComponent } from '../../modal/search-danger-name/search-danger-name.component';
import { Color } from '@ionic/core';
import { ConnectService } from 'src/app/basic/service/core/connect.service';
import { LanguagePackService } from 'src/app/basic/service/core/language-pack.service';

@Component({
  selector: 'app-select-danger-name',
  templateUrl: './select-danger-name.component.html',
  styleUrls: ['./select-danger-name.component.scss'],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => SelectDangerNameComponent),
    multi: true
  }]
})
export class SelectDangerNameComponent implements OnInit, ControlValueAccessor {
  ...
  public async openModal() {
    ...
    const modal = await this._modal.create({
      component: SearchDangerNameComponent,
      componentProps: {
        type: this.type,
        all: this.all,
        value: this.value,
