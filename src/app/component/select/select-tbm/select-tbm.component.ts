...
import { ProjectItem, ProjectSearchType, SearchTbmComponent } from '../../modal/search-tbm/search-tbm.component';
import { Color } from '@ionic/core';
import { ConnectService } from 'src/app/basic/service/core/connect.service';
import { LanguagePackService } from 'src/app/basic/service/core/language-pack.service';

@Component({
  selector: 'app-select-tbm',
  templateUrl: './select-tbm.component.html',
  styleUrls: ['./select-tbm.component.scss'],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => SelectTbmComponent),
    multi: true
  }]
})
export class SelectTbmComponent implements OnInit, ControlValueAccessor {
