...
import { ProjectItem, ProjectSearchType, SearchActionPeopleComponent } from '../../modal/search-action-people/search-action-people.component';
...
@Component({
  selector: 'app-select-action-people',
  templateUrl: './select-action-people.component.html',
  styleUrls: ['./select-action-people.component.scss'],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => SelectActionPeopleComponent),
    multi: true
  }]
})
export class SelectActionPeopleComponent implements OnInit, ControlValueAccessor {
