...
@Component({
  selector: 'app-search-action-option',
  templateUrl: './search-action-option.component.html',
  styleUrls: ['./search-action-option.component.scss'],
})
export class SearchActionOptionComponent implements OnInit {
