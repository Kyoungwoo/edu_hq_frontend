...
@Component({
  selector: 'app-search-danger',
  templateUrl: './search-danger.component.html',
  styleUrls: ['./search-danger.component.scss'],
})
export class SearchDangerComponent implements OnInit {
