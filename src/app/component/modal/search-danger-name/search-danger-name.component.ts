...
@Component({
  selector: 'app-search-danger-name',
  templateUrl: './search-danger-name.component.html',
  styleUrls: ['./search-danger-name.component.scss'],
})
export class SearchDangerNameComponent implements OnInit {
