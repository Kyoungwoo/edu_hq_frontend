...
@Component({
  selector: 'app-search-ptw',
  templateUrl: './search-ptw.component.html',
  styleUrls: ['./search-ptw.component.scss'],
})
export class SearchPtwComponent implements OnInit {
